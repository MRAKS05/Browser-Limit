---
id: security
title: Security and Parental Lock
...
:::warning
The PIN is stored as a plaintext string in SharedPreferences. This is a known limitation. In a production environment, the PIN should be hashed (e.g., using SHA-256 or bcrypt) before storage.
:::
