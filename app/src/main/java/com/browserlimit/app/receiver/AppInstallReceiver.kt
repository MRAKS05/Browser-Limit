...
import com.browserlimit.app.data.ExceptionsManager
...
class AppInstallReceiver : BroadcastReceiver() {
                ...
                if (result.isBrowser) {
                    if (settingsManager.showOverlay.value) {
                        ...
                        if (success) {
                            ...
                            com.browserlimit.app.engine.NotificationHelper.sendUninstallNotification(context, appName, packageName, result.reason)
                        }
    ...
    private fun launchOverlayActivity(context: Context, packageName: String, method: String, reason: String) {
        val intent = Intent(context, com.browserlimit.app.ui.overlay.OverlayActivity::class.java).apply {
